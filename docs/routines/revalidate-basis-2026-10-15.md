...
- FIRST exit-grade read (Sept 25, 03:41 UTC, min=20): basis_x_cvd through its preset exit = PROMISING, +3.2 bps net, 48% win, n33, NOT stable, exits TP 4 / SL 6 / TIMEOUT 23, avg hold 9.7h. basis_extreme through its preset exit = NOISE, -8.3 bps net, 46% win, n299, NOT stable, exits TP 50 / SL 66 / TIMEOUT 183. Both reads are PREDICTIVE at 24h; the 12h preset exit mostly times out before the move lands. Compare the Oct 15 exit blocks against these.
