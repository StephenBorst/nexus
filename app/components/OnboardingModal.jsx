...
const STEPS = [
  { id: 1, tag: "STEP_01 / 03", title: "Connect Your Wallet", subtitle: "Non-custodial. Your keys, your funds.", description: "Any EVM wallet (MetaMask, Rabby, WalletConnect) or a Solana wallet. We never hold the funds. Positions settle on-chain.", cta: "Connect Wallet", icon: (<svg viewBox="0 0 40 40" fill="none" style={{ width: 38, height: 38 }}><rect x="4" y="10" width="32" height="22" rx="3" stroke="#ededf0" strokeWidth="1.5" /><path d="M4 16h32" stroke="#ededf0" strokeWidth="1.5" /><circle cx="28" cy="23" r="2.5" fill="#ededf0" /></svg>) },
  { id: 2, tag: "STEP_02 / 03", title: "Deposit USDC", subtitle: "Any chain. No bridging.", description: "Send USDC from Ethereum, Arbitrum, Base, Optimism, Solana or any EVM chain. Keep a little ETH on the source chain for gas. Arbitrum is the default.", cta: "Show Me Where", icon: (<svg viewBox="0 0 40 40" fill="none" style={{ width: 38, height: 38 }}><circle cx="20" cy="20" r="14" stroke="#ededf0" strokeWidth="1.5" /><path d="M20 10v20M14 15h9a3 3 0 010 6h-6a3 3 0 010 6h10" stroke="#ededf0" strokeWidth="1.5" strokeLinecap="round" /></svg>) },
  { id: 3, tag: "STEP_03 / 03", title: "Place Your First Trade", subtitle: "130+ markets. Up to 100x.", description: "Crypto, RWA and equity perps. Settled by Orderly on Arbitrum. No custodian.", cta: "Launch App", icon: (<svg viewBox="0 0 40 40" fill="none" style={{ width: 38, height: 38 }}><polyline points="4,30 14,18 22,24 36,8" stroke="#ededf0" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /><polyline points="28,8 36,8 36,16" stroke="#ededf0" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg>) },
];
