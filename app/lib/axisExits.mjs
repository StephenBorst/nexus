...
// names, per scoreboard axis, the preset that trades it (its signal, sizing and exit) (see AXIS_PRESET in
...
export const AXIS_EXITS = Object.freeze({
  basis_extreme: Object.freeze({ preset: "basis-extreme-fade", signalMode: "BASIS_FADE", basisConfirm: null, tpPercent: 2.5, slPercent: 2, maxHoldHours: 12, leverage: 5, capitalPerTrade: 50 }),
  basis_x_cvd: Object.freeze({ preset: "basis-cvd-stack", signalMode: "BASIS_FADE", basisConfirm: "CVD", tpPercent: 2.5, slPercent: 2, maxHoldHours: 12, leverage: 5, capitalPerTrade: 50 }),
});
